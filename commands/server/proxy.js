...
module.exports = async (client, message, args) => {
    ...
    if(!domainIP || domainIP !== '65.21.15.22') return msg.edit(`The domain you gave doesnt have the right ip address. the ip should be: \`65.21.15.22\` *without cloudflare proxy turned on*`)
